...
Data collected on those two variables for 24 production runs at a juice manufacturing plant are listed in \textbf{OJUICE} data set that I emailed.

> How to import data:

  1. Download (do not try to open) and upload the data file in to your working directory (the folder where your howemork is).

...
* Complete _Reporting with R Markdown_ [(DataCamp)](https://www.datacamp.com/courses/reporting-with-r-markdown) --- Due Feb 1

*  Complete _Introduction to the Tidyverse_ [(DataCamp)](https://www.datacamp.com/courses/introduction-to-the-tidyverse) --- Due Feb 1
...
* In class **quiz 04** --- Feb 14 (last 20 min of class)
...
* In class **Exam 02** --- Mar 21 (Allowed to use the `cheat sheet`)

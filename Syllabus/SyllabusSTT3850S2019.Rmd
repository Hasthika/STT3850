---
title: "STT 3850 Syllabus - Spring 2019"
author: ''
date: ''
output:
  html_document:
...
**Office Hours:** 12-2pm Tuesday & Thursday and by apppointment
...
* 15% of the course grade will come from **Homework + DataCamp assignments** (10-11 assignments)

* 20% of the course grade will come from **quizzes** (10) 

* 40% of the course grade will come from **mid-term exams** (2)

* 5% of the course grade will come from the **written assignments** (2)
...
The [CoursePacing guide](../CoursePacing/CoursePacingS2019.html) has all course assignments and due dates.

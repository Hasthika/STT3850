...
English conclusion: There is enough evidence to conclude that the Verizon spend significantly more time complete repairs for CLEC customers than for the ILEC customers.
...
obs_diff <- Del_by_Carrier[2,2] - Del_by_Carrier[1,2]
#
...
obs_diff <- del_by_month[1,2] - del_by_month[2,2]

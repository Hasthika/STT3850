...
Furthermore, the middle 50% of teaching scores were between _______ and _______ () while the middle 50% of beauty scores were between _______ and _______ out of 10.
...
```{r include=FALSE}
ggplot(evals_age, aes(x = age, y = score)) +
  geom_point() +
...
**Extraploation** is using the regression to predict $y$ from $x$ outside the range of $x$ values. Such predictions are often very bad.
